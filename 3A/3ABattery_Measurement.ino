...
int max_power = 255;
int off = 0;
float fudge_factor = 5.52; // 2 seconds || Experimental value from our bot to get time/degree turned
int day_range[2] = {450, 1024}; // range of acceptable voltage for daytime
int collision_range[2] = {0,1007}; // range of acceptable voltage to detect collision
